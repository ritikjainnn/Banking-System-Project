...
public class Deactivate extends JFrame
{
	...
	ImageIcon but1 = new ImageIcon("Images\\dec3.png");
	ImageIcon but2 = new ImageIcon("Images\\dec4.png");
...
//		New Account Heading
		title =  new JLabel("<html><u>DEACTIVATE</u></html>");
		title.setBounds(1300, 240, 500, 40);
...
//		Button
	...
	void applyDeactivate() throws Exception
	{
		Class.forName("com.mysql.jdbc.Driver");
		Connection co = DriverManager.getConnection
				("jdbc:mysql://127.0.0.1:3306/bank","root","root");
		Statement st = co.createStatement();
		st.executeUpdate("delete from userinfo where email = '"+Login.email+"'");
		st.executeUpdate("delete from "+Login.bname+" where accno = '"+Login.accno+"'");
		co.close();
